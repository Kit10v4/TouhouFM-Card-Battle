 ...
 */
class AIBot {
    constructor(name = "AI Bot", character = "Marisa", difficulty = "medium") {
    ...
    if (this.character === "Marisa" && card === "attack") {
            return opponentHp <= 60 && turn >= 5;
        }
        
    if (this.character === "Reimu" && card === "heal") {
            return this.hp <= 50;
        }
    ...
    canUseSpecial(card) {
        ...
        switch (this.character) {
            case "Marisa": return card === "attack";
            case "Reimu": return card === "heal";
    ...
    getAggressiveness() {
        ...
        // Character influence
    if (this.character === "Marisa") base += 0.2;
    ...
    if (this.character === "Marisa") base -= 0.1;
    ...
    if (this.character === "Reimu") base += 0.2;
    if (this.character === "Marisa") base -= 0.1;
