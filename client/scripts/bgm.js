...
(function(){
  ...
  const TRACKS = [
    (window.__ASSET_BASE__||'') + 'audio/bgm/bgm1.mp3',
    (window.__ASSET_BASE__||'') + 'audio/bgm/bgm2.mp3',
    (window.__ASSET_BASE__||'') + 'audio/bgm/bgm3.mp3',
    (window.__ASSET_BASE__||'') + 'audio/bgm/bgm4.mp3',
    (window.__ASSET_BASE__||'') + 'audio/bgm/bgm5.mp3'
  ];
